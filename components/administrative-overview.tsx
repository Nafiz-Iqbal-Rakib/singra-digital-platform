...
export function AdministrativeOverview() {
  return (
    <section id="administration" className="scroll-mt-24 bg-primary text-primary-foreground">
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1.4fr] lg:items-end">
          <Reveal>
            ...
            <p className="mt-5 text-pretty leading-relaxed text-primary-foreground/70">
              Key information about Singra Upazila. Figures shown are editable placeholders —
              replace them with verified official data.
            </p>
          </Reveal>
            ...
            <dl className="grid grid-cols-2 gap-x-8 gap-y-10 sm:grid-cols-3">
              {ADMIN_STATS.map((stat) => (
                <div key={stat.label}>
                  ...
                  <dd className="mt-2 font-serif text-4xl font-semibold tracking-tight md:text-5xl">
                    {stat.value}
                  </dd>
                </div>
              ))}
